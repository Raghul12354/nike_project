...
const initialState = {
    ...
    // cartItems: (typeof localStorage !== 'undefined') ? JSON.parse(localStorage.getItem("cart")) : []
    cartItems: [],
    cartTotalAmount: 0,
    cartTotalQantity: 0,
};
...
export const { setOpenCart, setCloseCart, setAddItemCart, setRemoveItemCart, setIncreaseItemQTY, setDecreaseItemQTY, setClearItemQTY, setGetTotals } = CartSlice.actions;
